...
function default_1(dataSources, resolverMappings, pubsub) {
    const resolvers = {};
    _.forEach(resolverMappings, (resolverMapping) => {
        ...
        let resolver = builder.buildResolver(dataSource, compiledRequestMapping, compiledResponseMapping);
...
//# sourceMappingURL=resolverMapper.js.map